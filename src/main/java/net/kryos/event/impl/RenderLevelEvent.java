...
public class RenderLevelEvent extends Event<RenderLevelListener> {
	...
	public RenderLevelEvent(GraphicsResourceAllocator resourceAllocator, DeltaTracker deltaTracker,
	...
	@Override
	public void post(RenderLevelListener listener) {
		listener.renderLevel(this);
	}
