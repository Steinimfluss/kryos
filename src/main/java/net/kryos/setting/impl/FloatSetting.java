...
public class FloatSetting extends Setting<Float> {
    ...
    private FloatSetting(String id, String name, float defaultValue, float min, float max, float step) {
	...
	public static class FloatSettingBuilder {
	    ...
	    public FloatSetting build() {
	    	FloatSetting floatSetting = new FloatSetting(id, name, defaultValue, min, max, step);
